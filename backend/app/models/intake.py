"""Intake models: Intake, IntakeParty, IntakeSession, Message.

Core data models for the intake system. All models live in per-tenant schemas.
"""
...
class IntakeParty(TenantBase):
    """A party involved in an intake (consumer, witness, etc.)."""
...
class IntakeSession(TenantBase):
    """A session within an intake (supports multi-session pause/resume)."""
...
class Message(TenantBase):
    """A message within an intake session."""
