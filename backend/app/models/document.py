"""Document upload and extraction models.
...
from sqlalchemy import JSON, Integer, LargeBinary, String, func
...
class UploadedDocument(TenantBase):
    """A document uploaded by a consumer as part of an intake."""
